...
import { Token } from './lib.ts'
import { Bl } from './bl.ts'
...
export interface Reference {
  ...
  obj: unknown | unknown[]
  includes(obj: unknown | unknown[]): boolean
}

export type OptionalTypeEncoder = (
  data: unknown,
  typ: string,
  options: EncodeOptions,
  refStack?: Reference
) => TokenOrNestedTokens | null

export type StrictTypeEncoder = (
  data: unknown,
  typ: string,
  options: EncodeOptions,
  refStack?: Reference
